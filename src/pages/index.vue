        ...
        <div class="about-body">
          ...
          <div class="contact-list">
            <a href="mailto:contact@jjank.com" class="contact-row">
              <svg class="contact-row-icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <rect
                  x="2"
                  y="4.5"
                  width="20"
            ...
            <a
              ...
              class="contact-row"
            >
              <svg class="contact-row-icon" viewBox="0 0 24 24" aria-hidden="true">
                <path
            ...
            <a
              ...
              class="contact-row"
            >
              <svg class="contact-row-icon" viewBox="0 0 32 32" aria-hidden="true">
                <path
